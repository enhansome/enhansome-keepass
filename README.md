...
* [KeePassXC](https://keepassxc.org/) - Cross-platform community fork of KeePass. ([source](https://github.com/keepassxreboot/keepassxc) ⭐ 28,846 | 🐛 902 | 🌐 C++ | 📅 2026-09-18)
...
* [OneKeePass](https://github.com/OneKeePass/desktop) ⭐ 498 | 🐛 5 | 🌐 Clojure | 📅 2026-09-17 - Secure password manager for macOS, Linux, and Windows.
...
* [MacPass](https://macpassapp.org/) - Native macOS KeePass client. ([source](https://github.com/MacPass/MacPass/) ⭐ 6,870 | 🐛 294 | 🌐 Objective-C | 📅 2026-09-15)
...
* [KeePassDX](https://play.google.com/store/apps/details?id=com.kunzisoft.keepass.free) - KeePass password manager for Android. ([source](https://github.com/Kunzisoft/KeePassDX) ⭐ 7,325 | 🐛 538 | 🌐 Kotlin | 📅 2026-09-15)
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - Password manager app for Android. ([source](https://github.com/PhilippC/keepass2android) ⭐ 6,232 | 🐛 1,174 | 🌐 C# | 📅 2026-09-17)
...
* [KeePassXC-Browser](https://github.com/keepassxreboot/keepassxc-browser) ⭐ 2,330 | 🐛 198 | 🌐 JavaScript | 📅 2026-09-16 - Browser extension for using KeePassXC with Chrome and Firefox.
...
* [pykeepass](https://github.com/libkeepass/pykeepass) ⭐ 509 | 🐛 42 | 🌐 Python | 📅 2026-08-09 - Python library for interacting with KeePass databases with KDBX3 and KDBX4 support.
...
* [KeePassRPC](https://github.com/kee-org/keepassrpc) ⭐ 677 | 🐛 7 | 🌐 C# | 📅 2024-07-04 - KeePass plugin used by the Kee browser add-on to connect browsers to KeePass.
...
* [keepass-2-file](https://github.com/Dracks/keepass-2-file) ⭐ 8 | 🐛 12 | 🌐 Rust | 📅 2026-09-17 - Command-line tool for generating plaintext config files from secrets stored in a KeePass database.
...
* [John the Ripper keepass2john](https://github.com/openwall/john/blob/bleeding-jumbo/src/keepass2john.c) ⭐ 13,641 | 🐛 515 | 🌐 C | 📅 2026-08-01 - Tool for extracting KeePass database hashes for John the Ripper and Hashcat.
