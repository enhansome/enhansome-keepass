...
* [KeePassXC](https://keepassxc.org/) - Cross-platform community fork of KeePass. ([source](https://github.com/keepassxreboot/keepassxc) ⭐ 28,841 | 🐛 901 | 🌐 C++ | 📅 2026-09-16)
...
* [AuthPass](https://github.com/authpass/authpass) ⭐ 2,790 | 🐛 167 | 🌐 Dart | 📅 2026-09-15 - Password manager based on Flutter for all platforms with KeePass 2.x compatibility.
* [OneKeePass](https://github.com/OneKeePass/desktop) ⭐ 497 | 🐛 6 | 🌐 Clojure | 📅 2026-09-17 - Secure password manager for macOS, Linux, and Windows.
...
* [MacPass](https://macpassapp.org/) - Native macOS KeePass client. ([source](https://github.com/MacPass/MacPass/) ⭐ 6,869 | 🐛 293 | 🌐 Objective-C | 📅 2026-09-15)
...
* [Strongbox](https://strongboxsafe.com/) - Source-available commercial password manager for macOS with a free tier. ([source](https://github.com/strongbox-password-safe/Strongbox) ⭐ 1,464 | 🐛 230 | 🌐 Objective-C | 📅 2026-07-17)
...
* [KeePassDX](https://play.google.com/store/apps/details?id=com.kunzisoft.keepass.free) - KeePass password manager for Android. ([source](https://github.com/Kunzisoft/KeePassDX) ⭐ 7,321 | 🐛 535 | 🌐 Kotlin | 📅 2026-09-15)
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - Password manager app for Android. ([source](https://github.com/PhilippC/keepass2android) ⭐ 6,230 | 🐛 1,173 | 🌐 C# | 📅 2026-09-17)
...
* [KeePassVault](https://play.google.com/store/apps/details?id=com.ivanovsky.passnotes) - KeePass password manager for Android. ([source](https://github.com/aivanovski/keepassvault) ⭐ 118 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-26)
...
* [KeePassXC-Browser](https://github.com/keepassxreboot/keepassxc-browser) ⭐ 2,328 | 🐛 197 | 🌐 JavaScript | 📅 2026-09-16 - Browser extension for using KeePassXC with Chrome and Firefox.
...
* [KeePassJava2](https://github.com/jorabin/KeePassJava2) ⭐ 286 | 🐛 16 | 🌐 Java | 📅 2026-03-17 - Java API for reading and writing KeePass 2.x databases and reading KeePass 1.x databases.
...
* [KeePassOTP](https://github.com/Rookiestyle/KeePassOTP) ⭐ 514 | 🐛 0 | 🌐 C# | 📅 2026-09-17 - KeePass 2 plugin for generating TOTP, HOTP, Steam, and legacy Yandex OTP codes.
...
* [John the Ripper keepass2john](https://github.com/openwall/john/blob/bleeding-jumbo/src/keepass2john.c) ⭐ 13,640 | 🐛 515 | 🌐 C | 📅 2026-08-01 - Tool for extracting KeePass database hashes for John the Ripper and Hashcat.
...
* [KeePassJava2 Format Notes](https://github.com/jorabin/KeePassJava2#keepassjava2-and-keepass) ⭐ 286 | 🐛 16 | 🌐 Java | 📅 2026-03-17 - Schema and diagram for KeePassJava2 database handling.
