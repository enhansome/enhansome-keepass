...
* [KeePassXC](https://keepassxc.org/) - Cross-platform community fork of KeePass. ([source](https://github.com/keepassxreboot/keepassxc) ⭐ 28,753 | 🐛 909 | 🌐 C++ | 📅 2026-09-10)
* [KeeWeb](https://keeweb.info/) - Free cross-platform password manager compatible with KeePass. ([source](https://github.com/keeweb/keeweb) ⭐ 12,990 | 🐛 441 | 🌐 HTML | 📅 2026-05-08)
* [AuthPass](https://github.com/authpass/authpass) ⭐ 2,786 | 🐛 165 | 🌐 Dart | 📅 2026-08-28 - Password manager based on Flutter for all platforms with KeePass 2.x compatibility.
* [OneKeePass](https://github.com/OneKeePass/desktop) ⭐ 494 | 🐛 6 | 🌐 Clojure | 📅 2026-09-02 - Secure password manager for macOS, Linux, and Windows.
...
* [KeeVault](https://github.com/lyj404/keevault) ⭐ 6 | 🐛 0 | 🌐 Dart | 📅 2026-09-02 - Cross-platform password manager built with Flutter, KeePass compatible (KDBX 3.x/4.x) with WebDAV sync, TOTP, and biometric unlock.
...
* [MacPass](https://macpassapp.org/) - Native macOS KeePass client. ([source](https://github.com/MacPass/MacPass/) ⭐ 6,863 | 🐛 294 | 🌐 Objective-C | 📅 2026-09-08)
* [KeePassium](https://keepassium.com/) - Open-source commercial password manager for macOS with a free tier. ([source](https://github.com/keepassium/KeePassium) ⭐ 1,689 | 🐛 95 | 🌐 Swift | 📅 2026-05-23)
* [Strongbox](https://strongboxsafe.com/) - Source-available commercial password manager for macOS with a free tier. ([source](https://github.com/strongbox-password-safe/Strongbox) ⭐ 1,459 | 🐛 227 | 🌐 Objective-C | 📅 2026-07-17)
...
* [KeeWeb](https://github.com/keeweb/keeweb) ⭐ 12,990 | 🐛 441 | 🌐 HTML | 📅 2026-05-08 - Free cross-platform password manager compatible with KeePass.
...
* [keepass4web-rs](https://github.com/lixmal/keepass4web-rs) ⭐ 53 | 🐛 13 | 🌐 Rust | 📅 2026-09-10 - Rust rewrite of keepass4web.
...
* [KeePassDX](https://play.google.com/store/apps/details?id=com.kunzisoft.keepass.free) - KeePass password manager for Android. ([source](https://github.com/Kunzisoft/KeePassDX) ⭐ 7,268 | 🐛 536 | 🌐 Kotlin | 📅 2026-09-10)
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - Password manager app for Android. ([source](https://github.com/PhilippC/keepass2android) ⭐ 6,222 | 🐛 1,171 | 🌐 C# | 📅 2026-09-09)
...
* [KeePassVault](https://play.google.com/store/apps/details?id=com.ivanovsky.passnotes) - KeePass password manager for Android. ([source](https://github.com/aivanovski/keepassvault) ⭐ 117 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-26)
...
* [KeePassXC-Browser](https://github.com/keepassxreboot/keepassxc-browser) ⭐ 2,325 | 🐛 196 | 🌐 JavaScript | 📅 2026-09-10 - Browser extension for using KeePassXC with Chrome and Firefox.
...
* [passhole](https://github.com/Evidlo/passhole) ⭐ 230 | 🐛 11 | 🌐 Python | 📅 2026-04-21 - Command-line password manager inspired by pass.
...
* [pykeepass](https://github.com/libkeepass/pykeepass) ⭐ 507 | 🐛 42 | 🌐 Python | 📅 2026-08-09 - Python library for interacting with KeePass databases with KDBX3 and KDBX4 support.
...
* [KeePassOTP](https://github.com/Rookiestyle/KeePassOTP) ⭐ 512 | 🐛 0 | 🌐 C# | 📅 2026-08-29 - KeePass 2 plugin for generating TOTP, HOTP, Steam, and legacy Yandex OTP codes.
...
* [pass import](https://github.com/roddhjav/pass-import) ⭐ 915 | 🐛 22 | 🌐 Python | 📅 2026-06-07 - Extension for pass that imports data from existing password managers.
...
* [keepass-2-file](https://github.com/Dracks/keepass-2-file) ⭐ 8 | 🐛 12 | 🌐 Rust | 📅 2026-09-10 - Command-line tool for generating plaintext config files from secrets stored in a KeePass database.
...
* [John the Ripper keepass2john](https://github.com/openwall/john/blob/bleeding-jumbo/src/keepass2john.c) ⭐ 13,612 | 🐛 515 | 🌐 C | 📅 2026-08-01 - Tool for extracting KeePass database hashes for John the Ripper and Hashcat.
